...
# and defined at the same indentation level as main (i.e., not nested under any classes or functions).
...
# Do not use this tool on a host that you don't have permission to test!
